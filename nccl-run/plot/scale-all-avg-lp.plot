...
# for allreduce
#plot 'allreduce-scale-2-bw-avg.dat' u 2:3:xtic(1) w lp title 'Scale=2', \
#     'allreduce-scale-4-bw-avg.dat' u 2:3:xtic(1) w lp title 'Scale=4', \
...
#     'allreduce-scale-213-bw-avg.dat' u 2:3:xtic(1) w lp title 'Scale=213'


# for alltoall
plot 'alltoall-scale-2-bw-avg.dat' u 1:2 w lp title 'Scale=2', \
     'alltoall-scale-4-bw-avg.dat' u 1:2 w lp title 'Scale=4', \
     ...
     'alltoall-scale-213-bw-avg.dat' u 1:2 w lp title 'Scale=213'
